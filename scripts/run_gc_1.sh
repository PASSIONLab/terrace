...
GC_QUERIES=gc_queries_new_1
GC_UPDATES=gc_updates_new_1
...
#numactl -i all ./graphstore/graph_bm -TC 1 -f $1 -rounds $ROUNDS -src $2 >> $3\_96\_$2 
  ...
  taskset -c 24 ./graphstore/graph_bm_no_update -TC 1 -f $1 -rounds $ROUNDS -src $2 >> $3\_1\_$2 
...
#numactl -i all ./graphstore/graph_bm -f $1 -rounds $ROUNDS -src $2 >> $3\_96\_$2 
  ...
  taskset -c 24 ./graphstore/graph_bm -f $1 -rounds $ROUNDS -src $2 >> $3\_1\_$2 
...
#numactl -i all ./graphstore/graph_bm_no_update -f $1 -rounds $ROUNDS -src $2 >> $3\_96\_$2 
  ...
  taskset -c 24 ./graphstore/graph_bm_no_update -f $1 -rounds $ROUNDS -src $2 >> $3\_1\_$2 
...
#numactl -i all ./graphstore/graph_bm_weighted -f $1 -rounds $ROUNDS -src $2 >> $3\_96\_$2 
  ...
  taskset -c 24 ./graphstore/graph_bm_weighted -f $1 -rounds $ROUNDS -src $2 >> $3\_1\_weighted\_$2 
